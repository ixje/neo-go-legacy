...
import (
	...
	"github.com/ixje/neo-go-legacy/pkg/compiler"
...
func TestRemove(t *testing.T) {
	srcTmpl := `package foo
	import "github.com/ixje/neo-go-legacy/pkg/interop/util"
	func Main() int {
		a := %s
		util.Remove(a, %d)
		return len(a) * a[%d]
...
func TestAppCall(t *testing.T) {
	const srcDynApp = `
	package foo
	import "github.com/ixje/neo-go-legacy/pkg/interop/engine"
